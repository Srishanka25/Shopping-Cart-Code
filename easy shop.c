...
void delete_books();
void delete_clothes();
void delete_tech_products();
void delete_shoe();
void change();
void bill();
int i,n,bid,bi,nb,cid,ci,nc,tid,ti,nt,sid,si,ns,delid,pos=0,chanid=0,j,id,total,totalb,totalc,totalt,hs_no;
long long int ph_no;
char bch,cch,tch,ch,name[40],adress_state[40],adress_district[40],adress_street[40],adress_city[40];
struct books
{
	int id;
	char item_name[50];
